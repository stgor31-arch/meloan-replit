...
const STORIES: Story[] = [
    {
        ...
        screens: [
            { title: "📲 Сохраните на экран", text: "Meloan работает как полноценное приложение прямо с экрана вашего смартфона — без скачивания из магазинов приложений. Быстрый доступ в одно касание!", image: "/stories/install-1.png" },
    ...
    },
    {
        ...
        screens: [
            { title: "✨ Простая регистрация", text: "Войдите через Яндекс ID — и вы уже в системе. Никаких длинных анкет и ожидания подтверждения. Начните за 30 секунд!", image: "/stories/howto-1.png" },
